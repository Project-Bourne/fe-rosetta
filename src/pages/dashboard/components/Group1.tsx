      ...
      <div className="border border-sirp-dashbordb1 rounded-[1.5rem] bg-sirp-secondary2  h-[12rem] mt-5  p-3">
        <div>
          <div className="flex flex-row items-center gap-3 pt-5">
            <div>
              <Image
                src={require("../../../../public/icons/Frame 05.svg")}
                alt="documents"
      ...
      <div className="border border-sirp-dashbordb1 rounded-[1.5rem] bg-sirp-secondary2  h-[12rem] mt-5  p-3">
        <div>
          <div className="flex flex-row items-center gap-3 pt-5">
            <div>
              <Image
                src={require("../../../../public/icons/Frame 06.svg")}
                alt="documents"
                className="cursor-pointer"
                width={75}
              />
      ...
      <div className="border border-sirp-dashbordb1 rounded-[1.5rem] bg-sirp-secondary2  h-[12rem] mt-5  p-3">
        <div>
          <div className="flex flex-row items-center gap-3 pt-5">
            <div>
              <Image
                src={require("../../../../public/icons/Frame 07.svg")}
                alt="documents"
                className="cursor-pointer"
                width={100}
              />
      ...
      <div className="border border-sirp-dashbordb1 rounded-[1.5rem] bg-sirp-secondary2  h-[12rem] mt-5  p-3">
        <div>
          <div className="flex flex-row items-center gap-3 pt-5">
            <div>
              <Image
                src={require("../../../../public/icons/Frame 08.svg")}
                alt="documents"
                className="cursor-pointer"
                width={100}
              />
      ...
      <div className="border border-sirp-dashbordb1 rounded-[1.5rem] bg-sirp-secondary2  h-[12rem] mt-5  p-3">
        <div>
          <div className="flex flex-row items-center gap-3 pt-5">
            <div>
              <Image
                src={require("../../../../public/icons/Frame 09.svg")}
                alt="documents"
                className="cursor-pointer"
                width={100}
              />
      ...
      <div className="border border-sirp-dashbordb1 rounded-[1.5rem] bg-sirp-secondary2  h-[12rem] mt-5  p-3">
        <div>
          <div className="flex flex-row items-center gap-3 pt-5">
            <div>
              <Image
                src={require("../../../../public/icons/Frame 0100.svg")}
                alt="documents"
                className="cursor-pointer"
                width={100}
              />
      ...
      <div className="border border-sirp-dashbordb1 rounded-[1.5rem] bg-sirp-secondary2  h-[12rem] mt-5  p-3">
        <div>
          <div className="flex flex-row items-center gap-3 pt-5">
            <div>
              <Image
                src={require("../../../../public/icons/Frame 011.svg")}
                alt="documents"
                className=" cursor-pointer"
                width={100}
              />
      ...
      <div className="border border-sirp-dashbordb1 rounded-[1.5rem] bg-sirp-secondary2  h-[12rem] mt-5  p-3">
        <div>
          <div className="flex flex-row items-center gap-3 pt-5">
            <div>
              <Image
                src={require("../../../../public/icons/Frame 012.svg")}
                alt="documents"
                className="cursor-pointer"
                width={100}
              />
      ...
      <div className="border border-sirp-dashbordb1 rounded-[1.5rem] bg-sirp-secondary2  h-[12rem] mt-5  p-3">
        <div>
          <div className="flex flex-row items-center gap-3 pt-5">
            <div>
              <Image
                src={require("../../../../public/icons/Frame 013.svg")}
                alt="documents"
                className="cursor-pointer"
                width={100}
              />
