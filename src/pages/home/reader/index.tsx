...
import { setOriginalText, setTranslatedText, seTranslatedData } from '@/redux/reducer/translateSlice';
...
export default function Reader() {
    const { translatedData, original, translated, isSwapped } = useSelector((state: any) => state?.translate);
    ...
    const debouncedHandleChange = async () => {
        try {
            ...
            if (response.status) {
                dispatch(seTranslatedData(response.data))
